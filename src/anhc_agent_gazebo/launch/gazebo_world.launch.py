...
ARGUMENTS = [
    ...
    DeclareLaunchArgument(
        ...
        default_value=[
            os.path.join(
                get_package_share_directory("anhc_agent_gazebo"),
                "worlds",
                "td7_static.world",
            )
        ],
...
def generate_launch_description():
    ...
    *************************************************************************************"""
    anhc_agent_gazebo_package_name = "anhc_agent_gazebo"
    anhc_agent_description_package_name = "anhc_agent_description"
    velodyne_description_package_name = "velodyne_description"
    anhc_agent_gazebo_package_directory = get_package_share_directory(
        anhc_agent_gazebo_package_name
    )
    anhc_agent_description_package_directory = get_package_share_directory(
        anhc_agent_description_package_name
    )
    ...
    *************************************************************************************"""
    anhc_agent_gazebo_install_dir_path = (
        get_package_prefix(anhc_agent_gazebo_package_name) + "/share"
    )
    anhc_agent_install_dir_path = (
        get_package_prefix(anhc_agent_description_package_name) + "/share"
    )
    velodyne_description_install_dir_path = (
        get_package_prefix(velodyne_description_package_name) + "/share"
    )

    robot_meshes_path = os.path.join(anhc_agent_description_package_directory, "meshes")
    velodyne_description_meshes_path = os.path.join(
        velodyne_description_package_directory, "meshes"
    )
    anhc_agent_description_models_path = os.path.join(
        anhc_agent_description_package_directory, "models"
    )
    anhc_agent_gazebo_models_path = os.path.join(
        anhc_agent_gazebo_package_directory, "models"
    )
    ...
    gazebo_resource_paths = [
        ...
        anhc_agent_install_dir_path,
        robot_meshes_path,
        anhc_agent_description_models_path,
        anhc_agent_gazebo_models_path,
        velodyne_description_install_dir_path,
