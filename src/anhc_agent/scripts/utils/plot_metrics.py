...
def plot_metrics(metrics_file_sets, labels, anhc_agent_src_path):
    """Plots separate horizontal bar charts for each metric comparing baseline and ours."""
    metrics_path = os.path.join(anhc_agent_src_path, "anhc_agent", "test_runs")
...
def main():
    ...
    plot_metrics(metrics_file_sets, labels, anhc_agent_src_path)
